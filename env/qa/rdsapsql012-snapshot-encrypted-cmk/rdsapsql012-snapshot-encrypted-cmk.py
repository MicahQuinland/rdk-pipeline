...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    try:    
        my_eval = {
            ...
            'Annotation': 'Amazon RDS Cluster Snapshot is not encrypted with CMK (Customer Managed Key)',
        ...
        if 'kmsKeyId' in configuration_item['configuration']:
            ...
            rds_managed_ky_id = ''
            key_id_in_use = configuration_item['configuration']['kmsKeyId'].split("/")[1]
            ...
            if key_id_in_use == rds_managed_ky_id:
                return my_eval
            else:
                return 'COMPLIANT'
        else:
