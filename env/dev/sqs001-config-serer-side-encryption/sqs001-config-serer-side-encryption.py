...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
    ...
    try:
        my_eval = {
            ...
            'Annotation': 'Amazon SQS in-transit Server-side encryption must be enabled using SQS or KMS Key',
        ...
        if configuration_item['configuration']['SqsManagedSseEnabled'] == "true": 
            return 'COMPLIANT'
        else:
            return my_eval
